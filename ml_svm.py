...
def create_dataset(stock_symbol, start_date, end_date, lags=5):
    ...
    # we want to use additional features: laagged returns ... today's returns, yesterday's returns etc
...
if __name__ == "__main__":
    ...
    #model = SVC(C=1000000, cache_size=200, class_weight=None, coef0=0.0, degree=3, gamma=0.0001, kernel='rbf',max_iter=-1)
    model = LinearSVC()
